...
fig.plot(x=df.loc[df["network"].isin("KMA"),"longitude"],y=df.loc[df["network"].isin("KMA"),"latitude"],fill="red",style="t0.2c",pen=True,label="KMA")
fig.plot(x=df.loc[df["network"].isin("KIGAM"),"longitude"],y=df.loc[df["network"].isin("KIGAM"),"latitude"],fill="green",style="t0.2c",pen=True,label="KIGAM+G0.1c")
fig.plot(x=df.loc[df["network"].isin("Temp"),"longitude"],y=df.loc[df["network"].isin("Temp"),"latitude"],fill="blue",style="t0.2c",pen=True,label="temporary+G0.1c")
