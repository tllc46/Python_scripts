...
fig.grdview(grid=0.001*grid_relief,cmap="geo",shading="+d",projection="merc/10c",zscale="1c",plane=0,surftype="s",region=[125.62,127.5115,32.8565,33.95,0,2],perspective=True) #must provide projection explicitly. colorbar initializes projection by -Jx1i
