...
fig.plot(x=df_events["longitude"],y=df_events["latitude"],fill="white",projection=f"aeqd/{longitude_center}/{latitude_center}/{horizon}/{radius_len}/0",region="g",style="c0.15c",pen=True)
