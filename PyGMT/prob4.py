...
fig.coast(land="whitesmoke",projection=f"aeqd/{longitude_center}/{latitude_center}/120/{radius_len}/0",region="g",water="darkgray")
...
fig.plot(data=df[["longitude","latitude"]],fill="white",projection=f"aeqd/{longitude_center}/{latitude_center}/120/{radius_len}/0",region="g",style="c0.15c",pen=True)
