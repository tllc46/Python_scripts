...
fig.plot(data=df["longitude"],y=df["latitude"],fill="white",projection=f"aeqd/{longitude_center}/{latitude_center}/120/{radius_len}c/0",region="g",style="c0.15c",pen=True)
