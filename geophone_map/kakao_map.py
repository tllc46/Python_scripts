...
df=pd.read_csv(filepath_or_buffer=input_file,sep=" ",names=["lat","lon","station","color"])
...
for index,data in df.iterrows():
    ...
    elem.click()
    #그룹 선택
    elem=wait.until(method=EC.visibility_of_element_located(locator=(By.XPATH,f'/html/body/div[20]/div[2]/div[2]/ul/li[a/span[2]/strong/text()="{group_name}"]/a')))
    elem.click()
    #별명 입력
